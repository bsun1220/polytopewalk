...
TEST_CASE( "Check Ball Walker Results (pass)", "[require]" ) {
    ...
    BallWalk ball(0.4);
    MatrixXd res_ball = ball.generateCompleteWalk(steps, init, A, b);
...
TEST_CASE( "Check Dikin Walker Results (pass)", "[require]" ) {
    ...
    DikinWalk dikin (0.5);
    MatrixXd res_dikin = dikin.generateCompleteWalk(steps, init, A, b);
...
TEST_CASE( "Check Vaidya Walker Results (pass)", "[require]" ) {
    ...
    MatrixXd res_vaidya = vaidya.generateCompleteWalk(steps, init, A, b);
...
TEST_CASE( "Check DikinLS Walker Results (pass)", "[require]" ) {
    ...
    MatrixXd res_dikinls = dikinls.generateCompleteWalk(steps, init, A, b);
...
TEST_CASE( "Check John Walker Results (pass)", "[require]" ) {
    ...
    MatrixXd res_john = john.generateCompleteWalk(steps, init, A, b);
...
TEST_CASE( "Check HitRun Walker Results (pass)", "[require]" ) {
    ...
    MatrixXd res_hr = hr.generateCompleteWalk(steps, init, A, b);
