...
class RandomWalk{
    ...
    public:
         ...
         * @return Matrix
         */
        virtual MatrixXd generateCompleteWalk(const int num_steps, VectorXd& x, const SparseMatrixXd& A, const VectorXd& b);
    ...
    protected: 
         ...
         * @return void
         */
        bool inPolytope(const VectorXd& z, const SparseMatrixXd& A, const VectorXd& b);
