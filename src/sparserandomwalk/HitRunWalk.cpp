...
double HitAndRunWalk::binarySearch(VectorXd direction, VectorXd& x, const SparseMatrixXd& A, const VectorXd& b){
...
MatrixXd HitAndRunWalk::generateCompleteWalk(const int num_steps, VectorXd& x, const SparseMatrixXd& A, const VectorXd& b){
    int n = x.rows(); 
